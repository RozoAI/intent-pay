...
6. **[ROZO_PAY_BUTTON_PROPS.md](./ROZO_PAY_BUTTON_PROPS.md)** - Full `RozoPayButton` / `RozoPayButton.Custom` prop reference (required vs optional + usage)
7. **[STELLAR_EXTERNAL_KIT_AND_CONNECT.md](./STELLAR_EXTERNAL_KIT_AND_CONNECT.md)** - Using your own Stellar kit and connecting wallets (single confirmation)
8. **[STELLAR_PAYOUT_IMPLEMENTATION_ANALYSIS.md](./STELLAR_PAYOUT_IMPLEMENTATION_ANALYSIS.md)** - Stellar-specific implementation details

### **For Payment Flow Understanding**
9. **[../packages/connectkit/PAYMENT_FLOW.md](../packages/connectkit/PAYMENT_FLOW.md)** - Detailed payment flow diagrams and state transitions
